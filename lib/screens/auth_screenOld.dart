...
class AuthScreenOld extends StatefulWidget {
  AuthScreenOld({Key key}) : super(key: key);

  @override
  _AuthScreenOldState createState() => _AuthScreenOldState();
}

class _AuthScreenOldState extends State<AuthScreenOld> {
